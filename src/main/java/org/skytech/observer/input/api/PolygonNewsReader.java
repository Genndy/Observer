...
public class PolygonNewsReader {
    ...
    public List<InputDataNews> parseJsonToNewsObject(JSONArray jsonArrayData, String symbolName) throws JSONException, IOException, ParseException {
        ...
        for(int i = 0; i < jsonArrayData.length(); i++){
            ...
            InputDataNews inputNews = new InputDataNews(symbolName, description, date, source, "акция", text);
    ...
    public List<InputDataNews> getInputDataNewsListByDate(int page, String name) {
        ...
        try {
        String[] tokens = {"P2z6sI_gKGe8J0XphpPrcsK8jZoXdsL5", "EWlMht7GAk8vgnV0EWSp92C26aFYKCo2", "y1yulUeMzGWF3tzR4etfUVL5Hc9VE_pk", "PV2ySRnDwTEXIfNmA5miSLTVpY56TRl8", "KXvwR5LJpspA2jv44b32QFYttI2HY0Ek", "yeqUAMSQemGnAz5jmdtYfps3kKFEN2lD"};
